...
export interface GenerateButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  /**
   * Primary button label when idle. Defaults to "Generate".
   */
  text?: string;
  /**
   * Button label when generating/active. Defaults to "Generating".
   */
  generatingText?: string;
  /**
   * Optional className for the outer container wrapper.
   */
...
export function GenerateButton({
  ...
  return (
    <div className={cn("relative group w-full", containerClassName)}>
      <style>{`
        ...
        @keyframes gen-focused-letter-anim {
          ...
          50% {
            ...
            filter: blur(1px) brightness(150%) drop-shadow(0 0 8px hsl(var(--highlight-color-hue), 100%, 70%));
          }
        }
        ...
        .gen-btn[data-generating="true"] .gen-btn-svg {
          ...
          fill: hsl(var(--highlight-color-hue), 100%, 75%);
        ...
        .gen-btn-letter:nth-child(2), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(2) { animation-delay: 0.04s; }
        .gen-btn-letter:nth-child(3), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(3) { animation-delay: 0.08s; }
        .gen-btn-letter:nth-child(4), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(4) { animation-delay: 0.12s; }
        .gen-btn-letter:nth-child(5), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(5) { animation-delay: 0.16s; }
        .gen-btn-letter:nth-child(6), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(6) { animation-delay: 0.20s; }
        .gen-btn-letter:nth-child(7), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(7) { animation-delay: 0.24s; }
        .gen-btn-letter:nth-child(8), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(8) { animation-delay: 0.28s; }
        .gen-btn-letter:nth-child(9), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(9) { animation-delay: 0.32s; }
        .gen-btn-letter:nth-child(10), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(10) { animation-delay: 0.36s; }
        .gen-btn-letter:nth-child(11), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(11) { animation-delay: 0.40s; }
        .gen-btn-letter:nth-child(12), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(12) { animation-delay: 0.44s; }
        .gen-btn-letter:nth-child(13), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(13) { animation-delay: 0.48s; }
        .gen-btn-letter:nth-child(14), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(14) { animation-delay: 0.52s; }
        .gen-btn-letter:nth-child(15), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(15) { animation-delay: 0.56s; }
        .gen-btn-letter:nth-child(16), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(16) { animation-delay: 0.60s; }
        .gen-btn-letter:nth-child(17), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(17) { animation-delay: 0.64s; }
        .gen-btn-letter:nth-child(18), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(18) { animation-delay: 0.68s; }
        .gen-btn-letter:nth-child(19), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(19) { animation-delay: 0.72s; }
        .gen-btn-letter:nth-child(20), .gen-btn[data-generating="true"] .gen-btn-letter:nth-child(20) { animation-delay: 0.76s; }
      ...
      <button
        type="button"
        className={cn("gen-btn w-full", className)}
      ...
      >
        ...
        <div className="gen-txt-wrapper">
          {/* Invisible sizing anchor that auto-expands the wrapper to the exact text length */}
          <span className="invisible opacity-0 select-none pointer-events-none px-1">
            {text.length >= generatingText.length ? text : generatingText}
          </span>

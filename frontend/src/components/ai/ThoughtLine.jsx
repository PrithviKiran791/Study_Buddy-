...
/**
 * ThoughtLine Component
 * Provides both the header text status with live timer and the dynamic horizontal thought rail.
 */
export default function ThoughtLine({
  ...
  }, [isWorking, doneText, label, showTimer]);
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-2 w-full">
        {/* Header line with label, glyph, timer, chevron */}
        {collapsible ? (
          <button
            type="button"
        ...
        {/* Visual Animated Thought Track (● ──────── ✦ ──────── ○ ──────── ✦ ──────── ●) */}
        {showTrack && isWorking && (
          <div className="tl-track-container" aria-hidden="true">
            <span className="tl-endpoint tl-endpoint--left" />
            <div className="tl-rail">
              <div className="tl-rail-shimmer" />
            </div>
            <span className="tl-midpoint" />
            <span className="tl-particle" />
            <div className="tl-traveler">
              <div className="tl-traveler-core" />
            </div>
            <span className="tl-endpoint tl-endpoint--right" />
          </div>
        )}

        {/* Optional Collapsible Step Trace */}
        {hasTrace ? (
